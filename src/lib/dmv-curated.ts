...
const EVENTS: CuratedSpec[] = [
  ...
  {
    id: "dmv-mdhall-writers-roundtable-lolordo-isaacs-20260819",
    year: 2026,
    monthIndex: 7,
    day: 19,
    hour: 18,
    ...
    endHour: 19,
    endMinute: 30,
    title: "The Writers' RoundTable: Poets in Conversation — Ann LoLordo & Jenny Isaacs",
    tagline: "Maryland Hall · Annapolis · Free · Registration required",
    description:
      "The Maryland Hall Writers' Roundtable welcomes Finishing Line Press authors Ann LoLordo (Materfamilias) and Jenny Isaacs (The Argument of Time) for an evening of poetry, conversation, and unexpected connections. Free; registration required. Questions: writers.mdhall@gmail.com.",
    category: "reading",
    organizer: "The Writers' RoundTable at Maryland Hall",
    venue: "Maryland Hall — Community Room (2nd floor, Room 206)",
    address: "801 Chase Street, Annapolis, MD 21401",
    neighborhood: "Annapolis",
    rsvpUrl: "https://forms.gle/JbXNseFPinTuhLbAA",
    price: "free",
