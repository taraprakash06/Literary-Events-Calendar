...
const PROGRAMS: LaPoetSocietyProgram[] = [
  ...
  {
    slug: "speakeasy-bodevi",
    title: "Speakeasy at Bodevi",
    tagline: "LA Poet Society · Last Fridays",
    description: "Monthly literary showcase from Los Angeles Poet Society.",
    recurrence: { kind: "last", weekday: 5 },
    start: { hour: 19, minute: 0 },
    end: { hour: 21, minute: 0 },
    format: "in-person",
    category: "reading",
