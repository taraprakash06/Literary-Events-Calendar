...
const CENTRAL_LIBRARY_ADDRESS = "201 W. Mifflin Street, Madison, WI 53703";
const CAPITOL_THEATER_ADDRESS = "201 State Street, Madison, WI 53703";
const FITCHBURG_LIBRARY_ADDRESS = "5530 Lacy Road, Fitchburg, WI 53711";
const WBF_SCHEDULE_URL = "https://www.wisconsinbookfestival.org/event-schedule";
const WBF_FALL_URL =
  "https://www.cityofmadison.com/news/2026-09-09/wisconsin-book-festival-celebrates-25th-anniversary-fall-celebration-featuring-55";
...
function micOnStateEvents(): CuratedSpec[] {
  ...
  return wednesdaysInRange(start, end).map((d) => {
    ...
    return {
      ...
      description:
        "One of the country’s largest open mics, The Mic on State runs every Wednesday at Comedy on State with about 20 comedians each week. Doors open to the public at 6:30 PM, showtime is 8:00 PM, and admission is $5 at the door — seating is first come, first served with no beverage minimum. Performer sign-up is online only Wednesdays 12–6 PM (signing up does not guarantee a spot).",
      category: "open-mic",
...
function roomOfOnesOwnEvents(): CuratedSpec[] {
  ...
  return [
    ...
    },
    {
      ...
      description:
        "Book talk and performance stop on the Remaking Democracy tour. Danielle Chynoweth and Elizabeth Adams present Remaking Democracy: How We Make the Worlds We Want — a guidebook for social change — with Norman Stockwell (publisher of The Progressive) and Andy Gricevich (musician, poet, and forager). Wednesday, September 23, 6–7pm at A Room of One’s Own.",
      category: "reading",
      organizer: "A Room of One's Own",
      venue: "A Room of One's Own Bookstore",
      address: ROOM_ADDRESS,
    ...
    },
    {
      ...
      description:
        "Poetry reading celebrating Serena Chopra’s A Catalog of Future Mercies, with additional readings from Patrycja Humienik and Nicholas Gulig. Thursday, September 24, 6–7pm at A Room of One’s Own.",
      category: "reading",
      organizer: "A Room of One's Own",
      venue: "A Room of One's Own Bookstore",
      address: ROOM_ADDRESS,
    ...
    },
    {
      ...
      description:
        "Monthly queer movie night hosted by bookseller Celena using Kanopy’s library. Screening the film Please Baby Please. Film begins around 7pm in The Reading Room. Masks required.",
      category: "other",
      organizer: "A Room of One's Own",
      venue: "The Reading Room",
      address: READING_ROOM_ADDRESS,
    ...
    },
    {
      ...
      tagline: "A Room of One's Own · Reading Room · Free",
      description:
        "The Lit Study Book Club (hosted by bookseller Jay Lowe) discusses Country People by Daniel Mason. Meets the second Saturday of the month, 3–4pm, in The Reading Room next door to the bookstore. Saturday, October 10.",
      category: "reading",
      organizer: "A Room of One's Own",
      venue: "The Reading Room",
      address: READING_ROOM_ADDRESS,
    ...
    {
      id: "madison-room-andaleeb-cartonera-20260926",
      year: 2026,
      monthIndex: 8,
      day: 26,
      hour: 14,
      ...
      endHour: 17,
      endMinute: 0,
      title: "Andaleeb Cartonera: Handcrafting Books About Palestine",
      tagline: "A Room of One's Own · Reading Room · Drop-in workshop",
      description:
        "Andaleeb Cartonera is an independent cardboard book press inspired by Latin American cartoneras, making low-cost handcrafted books with recycled cardboard. Join this monthly drop-in bookmaking workshop about Palestine at The Reading Room — anyone is welcome, no pre-registration required, and art supplies are provided.",
      category: "workshop",
      organizer: "A Room of One's Own",
      venue: "The Reading Room",
      address: READING_ROOM_ADDRESS,
      neighborhood: "Atwood",
      rsvpUrl:
        "https://roomofonesown.com/event/2026-09-26/andaleeb-cartonera-handcrafting-books-about-palestine",
      sourceChannel: "bookstore",
      source: "A Room of One's Own",
      price: "free",
      format: "in-person",
    ...
    {
      id: "madison-room-nate-lippens-bastards-20261001",
      year: 2026,
      monthIndex: 9,
      day: 1,
      hour: 18,
      ...
      endHour: 19,
      endMinute: 0,
      title: "Bastards by Nate Lippens in Conversation with Ranee Zaporski",
      tagline: "A Room of One's Own · Fiction · Free",
      description:
        "Nate Lippens reads from and discusses Bastards in conversation with Ranee Zaporski. Thursday, October 1, 6–7pm at A Room of One’s Own Bookstore.",
      category: "reading",
      organizer: "A Room of One's Own",
      venue: "A Room of One's Own Bookstore",
      address: ROOM_ADDRESS,
      neighborhood: "Atwood",
      rsvpUrl:
        "https://roomofonesown.com/event/2026-10-01/bastards-nate-lippens-conversation-ranee-zaporski",
      sourceChannel: "bookstore",
      source: "A Room of One's Own",
      price: "free",
      format: "in-person",
...
const CURATED: CuratedSpec[] = [
  ...
  },
  {
    ...
    neighborhood: "State Street",
    rsvpUrl:
      "https://roomofonesown.com/event/2026-09-22/patti-smith-songs-stories-book-bundled-event-room-ones-own",
    sourceChannel: "bookstore",
  ...
  },
  {
    ...
    description:
      "Siri Carpenter — cofounder of The Open Notebook and editor of The Best Science Stories and How They Work — discusses that science-journalism anthology in conversation with Kelly Tyrrell, who directs communications strategy at The Open Notebook. The book gathers eleven deeply reported stories with annotations by leading science writers, drawn from outlets such as Scientific American, Nature, The Atlantic, and The New York Times Magazine. Each piece includes an introduction, annotations, and a Q&A between author and annotator on how the reporting and writing came together. Please RSVP — seating is limited and guaranteed only for those who RSVP. Livestream available for those who can’t attend in person.",
    category: "reading",
  ...
  {
    id: "madison-fitchburg-fantasy-book-club-gideon-the-ninth-20261008",
    year: 2026,
    monthIndex: 9,
    day: 8,
    hour: 18,
    ...
    endHour: 19,
    endMinute: 0,
    title: "Fantasy Book Club: Gideon the Ninth by Tamsyn Muir",
    tagline: "Fitchburg Public Library · Free",
    description:
      "Fantasy Book Club at Fitchburg Public Library discusses Gideon the Ninth by Tamsyn Muir. Thursday, October 8, 6:00–7:00 PM. Copies may be available at the Reference Desk — check the library calendar listing for details.",
    category: "reading",
    organizer: "Fitchburg Public Library",
    venue: "Fitchburg Public Library",
    address: FITCHBURG_LIBRARY_ADDRESS,
    neighborhood: "Fitchburg",
    rsvpUrl:
      "https://fitchburgwi.gov/Calendar.aspx?EID=18922&calType=0&day=12&month=10&year=2026",
    sourceChannel: "library",
    source: "Fitchburg Public Library",
    price: "free",
    format: "in-person",
  },
  {
    id: "madison-fitchburg-silent-book-club-20261010",
    year: 2026,
    monthIndex: 9,
    day: 10,
    hour: 10,
    ...
    endHour: 12,
    endMinute: 0,
    title: "Fitchburg Silent Book Club",
    tagline: "Fitchburg Public Library · Free",
    description:
      "Silent Book Club at Fitchburg Public Library — bring whatever you’re reading and enjoy quiet reading time in community. Saturday, October 10, 10:30 AM–12:00 PM.",
    category: "reading",
    organizer: "Fitchburg Public Library",
    venue: "Fitchburg Public Library",
    address: FITCHBURG_LIBRARY_ADDRESS,
    neighborhood: "Fitchburg",
    rsvpUrl:
      "https://fitchburgwi.gov/Calendar.aspx?EID=18564&calType=0&day=12&month=10&year=2026",
    sourceChannel: "library",
    source: "Fitchburg Public Library",
    price: "free",
    format: "in-person",
  ...
  {
    id: "madison-fitchburg-sci-fi-book-club-all-systems-red-20261012",
    year: 2026,
    monthIndex: 9,
    day: 12,
    hour: 18,
    ...
    endHour: 19,
    endMinute: 0,
    title: "Science Fiction Book Club: All Systems Red by Martha Wells",
    tagline: "Fitchburg Public Library · Free · 2nd Monday monthly",
    description:
      "Science Fiction Book Discussion meets on the second Monday of every month at 6:00 PM at Fitchburg Public Library. This month’s book is All Systems Red by Martha Wells. Copies are available at the second-floor Reference Desk. Email erin.saylor@fitchburgwi.gov for more information.",
    category: "reading",
    organizer: "Fitchburg Public Library",
    venue: "Fitchburg Public Library",
    address: FITCHBURG_LIBRARY_ADDRESS,
    neighborhood: "Fitchburg",
    rsvpUrl:
      "https://fitchburgwi.gov/Calendar.aspx?EID=18907&month=10&year=2026&day=12&calType=0",
    sourceChannel: "library",
    source: "Fitchburg Public Library",
    price: "free",
    format: "in-person",
  ...
  {
    id: "madison-fitchburg-evening-book-club-bog-queen-20261014",
    year: 2026,
    monthIndex: 9,
    day: 14,
    hour: 18,
    ...
    endHour: 19,
    endMinute: 30,
    title: "Evening Book Club: Bog Queen by Anna North",
    tagline: "Fitchburg Public Library · Free · 2nd Wednesday monthly",
    description:
      "Evening Book Club meets on the second Wednesday of the month at 6:30 PM at Fitchburg Public Library. This month’s book is Bog Queen by Anna North. Copies are available at the second-floor Reference Desk. Email minda.maurer@fitchburgwi.gov for more information.",
    category: "reading",
    organizer: "Fitchburg Public Library",
    venue: "Fitchburg Public Library",
    address: FITCHBURG_LIBRARY_ADDRESS,
    neighborhood: "Fitchburg",
    rsvpUrl:
      "https://fitchburgwi.gov/Calendar.aspx?EID=19003&calType=0&day=12&month=10&year=2026",
    sourceChannel: "library",
    source: "Fitchburg Public Library",
    price: "free",
    format: "in-person",
  ...
  {
    id: "madison-fitchburg-mystery-book-club-grave-reservations-20261015",
    year: 2026,
    monthIndex: 9,
    day: 15,
    hour: 18,
    ...
    endHour: 19,
    endMinute: 0,
    title: "Mystery Book Club: Grave Reservations by Cherie Priest",
    tagline: "Fitchburg Public Library · Free · Monthly",
    description:
      "Join fellow mystery readers for a monthly discussion at Fitchburg Public Library’s Conference Room. October’s book is Grave Reservations by Cherie Priest. Books are available for checkout at the Reference Desk. Email rebecca.swanson@fitchburgwi.gov with questions.",
    category: "reading",
    organizer: "Fitchburg Public Library",
    venue: "Fitchburg Public Library, Conference Room",
    address: FITCHBURG_LIBRARY_ADDRESS,
    neighborhood: "Fitchburg",
    rsvpUrl:
      "https://fitchburgwi.gov/Calendar.aspx?EID=18295&calType=0&day=12&month=10&year=2026",
    sourceChannel: "library",
    source: "Fitchburg Public Library",
    price: "free",
    format: "in-person",
  ...
  {
    id: "madison-fitchburg-swoon-society-the-pairing-20261020",
    year: 2026,
    monthIndex: 9,
    day: 20,
    hour: 18,
    ...
    endHour: 19,
    endMinute: 30,
    title: "Swoon Society Book Club: The Pairing by Casey McQuiston",
    tagline: "Fitchburg Public Library · Free",
    description:
      "Swoon Society Book Club at Fitchburg Public Library discusses The Pairing by Casey McQuiston. Tuesday, October 20, 6:30–7:30 PM. Check the library calendar listing for copy availability and details.",
    category: "reading",
    organizer: "Fitchburg Public Library",
    venue: "Fitchburg Public Library",
    address: FITCHBURG_LIBRARY_ADDRESS,
    neighborhood: "Fitchburg",
    rsvpUrl:
      "https://fitchburgwi.gov/Calendar.aspx?EID=19015&calType=0&day=12&month=10&year=2026",
    sourceChannel: "library",
    source: "Fitchburg Public Library",
    price: "free",
    format: "in-person",
  ...
  {
    id: "madison-fitchburg-wednesday-morning-book-club-20261021",
    year: 2026,
    monthIndex: 9,
    day: 21,
    hour: 10,
    ...
    endMinute: 0,
    title:
      "Wednesday Morning Book Club: Last Summer on State Street by Toya Wolfe",
    tagline: "Fitchburg Public Library · Free",
    description:
      "Wednesday Morning Book Club at Fitchburg Public Library discusses Last Summer on State Street by Toya Wolfe. Wednesday, October 21, 10:00–11:00 AM. Check the library calendar listing for copy availability and details.",
    category: "reading",
    organizer: "Fitchburg Public Library",
    venue: "Fitchburg Public Library",
    address: FITCHBURG_LIBRARY_ADDRESS,
    neighborhood: "Fitchburg",
    rsvpUrl:
      "https://fitchburgwi.gov/Calendar.aspx?EID=18890&calType=0&day=12&month=10&year=2026",
    sourceChannel: "library",
    source: "Fitchburg Public Library",
    price: "free",
    format: "in-person",
  ...
  },
  {
    ...
    endMinute: 0,
    title:
      'NewBridge Book Discussion of "Darius the Great is Not Okay" by Adib Khorram',
    tagline: "NewBridge · Online · Free",
    description:
      'Join us for a book discussion of "Darius the Great is Not Okay" by Adib Khorram. New members always welcome! Please check with library staff for location or Zoom link.',
    category: "reading",
    organizer: "NewBridge / Madison Public Library",
    format: "virtual",
    virtualLabel: "Online",
  ...
  {
    id: "madison-wbf-erika-meitner-assembled-audience-20260929",
    year: 2026,
    monthIndex: 8,
    day: 29,
    hour: 19,
    ...
    endHour: 20,
    endMinute: 0,
    title: "Assembled Audience by Erika Meitner",
    tagline: "Wisconsin Book Festival · Central Library · Free",
    description:
      "Wisconsin Book Festival presents Erika Meitner reading from Assembled Audience, her seventh poetry collection. Free and open to the public at Madison Public Library – Central, Community Rooms 301/302.",
    category: "reading",
    organizer: "Wisconsin Book Festival / Madison Public Library",
    venue: "Madison Public Library – Central, Community Rooms 301/302",
    address: CENTRAL_LIBRARY_ADDRESS,
    neighborhood: "Downtown",
    rsvpUrl:
      "https://roomofonesown.com/event/2026-09-29/wbf-presents-assembled-audience-erika-meitner",
    sourceChannel: "library",
    source: "Wisconsin Book Festival",
    price: "free",
    format: "in-person",
  },
  {
    id: "madison-wbf-john-green-hollywood-ending-20261001",
    year: 2026,
    monthIndex: 9,
    day: 1,
    hour: 19,
    ...
    endHour: 20,
    endMinute: 0,
    title: "Hollywood, Ending by John Green",
    tagline: "Wisconsin Book Festival · Capitol Theater · Free · Doors 6 PM",
    description:
      "Wisconsin Book Festival and A Room of One’s Own present John Green discussing his novel Hollywood, Ending, in conversation with Craig “Wheezy” Benzine. Free and open to the public; no ticket required — seating is first-come, first-served general admission. Doors open at 6:00 PM at the Capitol Theater at Overture Center. Pre-signed copies will be distributed free to attendees; there will not be a signing line or personalizations.",
    category: "reading",
    organizer: "Wisconsin Book Festival / A Room of One's Own",
    venue: "Capitol Theater at Overture Center",
    address: CAPITOL_THEATER_ADDRESS,
    neighborhood: "State Street",
    rsvpUrl:
      "https://roomofonesown.com/event/2026-10-01/hollywood-ending-john-green-capitol-theater",
    sourceChannel: "bookstore",
    source: "Wisconsin Book Festival / A Room of One's Own",
    price: "free",
    format: "in-person",
  },
  {
    id: "madison-wbf-fall-celebration-20261015",
    year: 2026,
    monthIndex: 9,
    day: 15,
    hour: 10,
    ...
    endHour: 20,
    endMinute: 0,
    title: "Wisconsin Book Festival — 25th Annual Fall Celebration",
    tagline: "Wisconsin Book Festival · Multiple venues · Free · Oct 15–18",
    description:
      "Four-day literary festival celebrating 25 years of the Wisconsin Book Festival, with more than 80 authors and 55+ free events across fiction, nonfiction, poetry, memoir, and more. Main programming runs October 15–18, 2026 at Madison Public Library Central Library, Madison Museum of Contemporary Art, the UW–Madison Discovery Building, and other Madison venues. See the festival schedule for the full lineup.",
    category: "other",
    organizer: "Wisconsin Book Festival / Madison Public Library",
    venue: "Multiple Madison venues",
    address: CENTRAL_LIBRARY_ADDRESS,
    neighborhood: "Madison",
    rsvpUrl: WBF_FALL_URL,
    rsvpIsGeneralCalendar: true,
    sourceChannel: "library",
    source: "Wisconsin Book Festival",
    price: "free",
  ...
  {
    id: "madison-wbf-poets-laureate-25th-20261016",
    year: 2026,
    monthIndex: 9,
    day: 16,
    hour: 19,
    ...
    endMinute: 30,
    title:
      "Current and Former Poets Laureate in Wisconsin: A 25th Anniversary Reading",
    tagline: "Wisconsin Book Festival · Central Library · Free",
    description:
      "Wisconsin Poet Laureate Brenda Cárdenas joins former Madison Poets Laureate Oscar Mireles and Angie Trudell Vasquez for a 25th-anniversary reading celebrating Wisconsin poetry. Friday, October 16, 7:30 PM at Madison Public Library – Central, Lower-Level Program Room. Free and open to the public.",
    category: "reading",
    organizer: "Wisconsin Book Festival / Madison Public Library",
    venue: "Madison Public Library – Central, Lower-Level Program Room",
    address: CENTRAL_LIBRARY_ADDRESS,
    neighborhood: "Downtown",
    rsvpUrl: WBF_SCHEDULE_URL,
    rsvpIsGeneralCalendar: true,
    sourceChannel: "library",
    source: "Wisconsin Book Festival",
    price: "free",
  ...
  {
    id: "madison-wbf-two-saddest-kitchens-20261016",
    year: 2026,
    monthIndex: 9,
    day: 16,
    hour: 19,
    ...
    endHour: 20,
    endMinute: 30,
    title: "The Two Saddest Kitchens with Roz Chast and Jason Adam Katzenstein",
    tagline: "Wisconsin Book Festival · Central Library · Free",
    description:
      "New Yorker cartoonists Roz Chast and Jason Adam Katzenstein discuss The Two Saddest Kitchens — a comics conversation about clutter, culinary aspirations, and the imperfect kitchens we actually inhabit. Friday, October 16, 7:30 PM at Madison Public Library – Central, Community Rooms 301/302. Free and open to the public.",
    category: "reading",
    organizer: "Wisconsin Book Festival / Madison Public Library",
    venue: "Madison Public Library – Central, Community Rooms 301/302",
    address: CENTRAL_LIBRARY_ADDRESS,
  ...
  {
    id: "madison-wbf-deesha-philyaw-20261017",
    year: 2026,
    monthIndex: 9,
    day: 17,
    hour: 15,
    ...
    tagline: "Wisconsin Book Festival · Central Library · Free",
    description:
      "PEN/Faulkner Award winner and National Book Award finalist Deesha Philyaw discusses her novel The True Confessions of First Lady Freeman — about the wife of a megachurch pastor whose secret past upends her “rags-to-Rolex” life. Saturday, October 17, 3:00 PM at Madison Public Library – Central, Community Room 301. Free and open to the public.",
    category: "reading",
    organizer: "Wisconsin Book Festival / Madison Public Library",
    venue: "Madison Public Library – Central, Community Room 301",
    address: CENTRAL_LIBRARY_ADDRESS,
    neighborhood: "Downtown",
    rsvpUrl: WBF_SCHEDULE_URL,
    rsvpIsGeneralCalendar: true,
  ...
  {
    id: "madison-wbf-ben-wikler-20261017",
    year: 2026,
    monthIndex: 9,
    day: 17,
    hour: 18,
    ...
    endHour: 19,
    endMinute: 0,
    title: "Ben Wikler — This Is The Plan",
    tagline: "Wisconsin Book Festival · Central Library · Free",
    description:
      "Madison native and former Democratic Party of Wisconsin chair Ben Wikler discusses his New York Times bestseller This Is The Plan, drawing on decades of organizing and Wisconsin’s contested political landscape. Saturday, October 17, 6:00 PM at Madison Public Library – Central, Community Rooms 301/302. Free and open to the public.",
    category: "reading",
    organizer: "Wisconsin Book Festival / Madison Public Library",
    venue: "Madison Public Library – Central, Community Rooms 301/302",
    address: CENTRAL_LIBRARY_ADDRESS,
  ...
  {
    id: "madison-wbf-scott-simon-20261018",
    year: 2026,
    monthIndex: 9,
    day: 18,
    hour: 12,
    ...
    endHour: 13,
    endMinute: 0,
    title: "Scott Simon — Ulysses S. Cat and Other Animals I Have Known",
    tagline: "Wisconsin Book Festival · Central Library · Free",
    description:
      "NPR Weekend Edition Saturday host Scott Simon shares Ulysses S. Cat and Other Animals I Have Known, warm stories about memorable animals and the bonds between people and animals. Sunday, October 18, 12:00 PM at Madison Public Library – Central, Community Rooms 301/302. Free and open to the public.",
    category: "reading",
    organizer: "Wisconsin Book Festival / Madison Public Library",
    venue: "Madison Public Library – Central, Community Rooms 301/302",
    address: CENTRAL_LIBRARY_ADDRESS,
